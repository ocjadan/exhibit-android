...
open class FetchQuestionAnswersUseCaseImpl(
    private val fetchQuestionAnswersEndpoint: FetchQuestionAnswersEndpoint,
    private val dispatcher: CoroutineDispatcher
) : BaseObservable<FetchQuestionAnswersUseCase.Listener>(), FetchQuestionAnswersUseCase {
    ...
    private suspend fun launchOnAllListeners(action: (listener: FetchQuestionAnswersUseCase.Listener) -> Unit) =
