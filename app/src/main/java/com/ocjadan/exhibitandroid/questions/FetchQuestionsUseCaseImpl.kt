...
open class FetchQuestionsUseCaseImpl(
...
) : BaseObservable<FetchQuestionsUseCase.Listener>(), FetchQuestionsUseCase {
    companion object {
    ...
    private suspend fun launchOnAllListeners(action: (listener: FetchQuestionsUseCase.Listener) -> Unit) =
